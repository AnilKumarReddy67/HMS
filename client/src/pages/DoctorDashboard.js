        ...
        <div className="main    m-2  ">
          ...
          <div className="">
            <div className="flex  h-12 m-2 bg-bgprimary rounded mt-4 ">
              ...
              <Link to="/doctor/profile">
                <div className="flex bg-white rounded shadow  px-4  ml-6 h-14 ">
                  <img
                    src={doctor_profile}
          ...
          >
            ...
            {Loading ? (
              ...
              <div className=" grid col-start-8  h-10 ml-2  bg-primary  rounded font-semibold font-poppins shadow-sm hover:bg-bgsecondary  ">
                <div className="flex py-2 px-4 items-center ">
                  <img src={search} className=" h-4  " alt="search"></img>
                  <button className="flex  rounded font-semibold font-poppins shadow-sm hover:bg-bgsecondary   ">
                    Search
                  </button>
                </div>
              </div>
            ...
            <div className="grid col-start-9  h-10 ml-4  bg-primary  rounded font-semibold font-poppins shadow-sm hover:bg-bgsecondary  ">
              <div className="flex py-2 px-4 items-center ">
                <div
                  className="flex cursor-pointer rounded font-semibold font-poppins shadow-sm hover:bg-bgsecondary "
                  onClick={() => {
                    props.setHealthID("");
                  }}
                >
